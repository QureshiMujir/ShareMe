...
const CreatePin = ({ user }) => {
  ...
  const GenerateParaphrase = () => {
    ...
    xhr.setRequestHeader("X-RapidAPI-Key", "bb7a9ef6a1mshe093314a38f39d1p1f9e12jsnad0214369de1");
  ...
  function GenerateSummary() {
    ...
    const options = {
      ...
      headers: {
        ...
        "X-RapidAPI-Key": "fa2dd5ba43msh92bef89c68bde5fp11095ajsn6ac6af13efd7",
